(function() {
  ...
  fetch_url = function(url, response, this_inst, parse_delay, request_headers, get_requests, get_cookies) {
    ...
    return page_inst.open(url, function(status) {
      var fetch_url_headers, i, script_is_injected, worker_script_result;
      if (done) {
        return true;
      } else {
        done = true;
      ...
      if (status !== "success") {
        ...
        return page_inst.parse_wait = setTimeout((function() {
          ...
          response.write(JSON.stringify({
            ...
            worker_script_result: worker_script_result != null ? worker_script_result : void 0,
